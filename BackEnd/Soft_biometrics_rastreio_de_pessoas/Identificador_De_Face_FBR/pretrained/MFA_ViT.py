...
try:
    from models.regularizer import DropPath
        ...
        try: 
            from Identificador_De_Face_FBR.models.regularizer import DropPath
        except:
                try: 
                    from Soft_biometrics_rastreio_de_pessoas.Identificador_De_Face_FBR.models.regularizer import DropPath
                except:        
                        from BackEnd.Soft_biometrics_rastreio_de_pessoas.Identificador_De_Face_FBR.models.regularizer import DropPath
